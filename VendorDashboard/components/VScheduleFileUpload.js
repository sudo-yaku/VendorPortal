...
import { downloadVSFile } from '../actions'

export class VScheduleFileUpload extends React.Component {
  ...
  fileDownload = (file_name, file_Id) => {
    let { loginId, downloadVSFile } = this.props
...
export default connect(null, { downloadVSFile })(VScheduleFileUpload)
